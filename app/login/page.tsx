      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="relative z-20 flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-md p-1.5 border border-white/30">
            <img src="/logo.png" alt="StudyOS Logo" className="w-full h-full object-contain brightness-0 invert" />
          </div>
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;This platform has completely transformed how I prepare for exams. The AI summaries help me understand complex topics in minutes.&rdquo;
            </p>
